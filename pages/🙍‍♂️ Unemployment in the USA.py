...
st.subheader(':blue[Total Civilian Labor Force in 5 most Popular States in the US from 2000 to 2022]')
...
df = pd.read_csv('C:/Users/user/Downloads/Unemploymentquyen.csv')
...
with c2:
    if selected_state:
        ...
        fig.update_layout(title=f"Total Civilian Labor Force in {selected_state} from 2000 to 2022",
                   xaxis_title='Year',
                   yaxis_title='Total Civilian Labor Force (1e7) - million')
        st.plotly_chart(fig)
